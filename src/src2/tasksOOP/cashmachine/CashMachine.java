...
import tasksOOP.cashmachine.api.ICashMAchineAdmin;
import tasksOOP.cashmachine.api.ICashMachineUser;
import tasksOOP.cashmachine.api.INote;

import java.util.*;

public class CashMachine implements ICashMachineUser, ICashMAchineAdmin {
